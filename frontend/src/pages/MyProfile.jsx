...
import { Briefcase, Star, Upload, FileText, CheckCircle } from 'lucide-react'
...
export default function MyProfile() {
  ...
  const handleUpload = async (e) => {
    ...
    try {
      ...
      // Refresh profile skills and resumes
  ...
  return (
    <div className="space-y-6 max-w-3xl">
      ...
      <div className="card flex items-center gap-5">
        ...
        {topSkill?.skillName && (
          <div className="text-right shrink-0">
            <p className="text-xs text-gray-400 dark:text-gray-500">Top Skill</p>
            <div className="flex items-center gap-1 mt-1 justify-end">
              <Star size={13} className="text-yellow-500" />
              <span className="text-sm font-medium text-gray-800 dark:text-gray-200">{topSkill.skillName}</span>
            </div>
          </div>
        )}
      </div>
      ...
      {/* Resume upload */}
      <div className="card">
        <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100 mb-4">Upload Resume</h3>
      ...
      <div className="card">
        ...
        {profile?.skills?.length > 0 ? (
          ...
          <p className="text-sm text-gray-400 dark:text-gray-500">
            Upload your resume above to auto-detect your skills.
          </p>
        )}
      </div>

      {/* Assigned projects with progress update */}
      <div className="card">
